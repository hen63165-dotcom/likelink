  ...
  if (new URL(req.url, "https://x").searchParams.get("mode") === "cloud-status") {
    try {
      ...
      return json(res, {
        ...
        ugcImageAiConfigured: Boolean(process.env.OPENAI_API_KEY),
        ugcVideoConfigured: Boolean(process.env.GEMINI_API_KEY),
        ugcVideoProvider: process.env.GEMINI_API_KEY ? "google_veo_3_1" : null,
