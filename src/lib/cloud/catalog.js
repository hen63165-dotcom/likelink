...
export function bootstrapProducts({ marketerId } = {}) {
  ...
  return [
    createProduct({ id: "p1", marketerId: owner, title: "נעלי ריצה נשים קלות — עד ₪189", description: "נעלי ריצה נוחות עם כרית אוויר. מתאימות לריצה והליכה. מדות 36-41.", price: 189, category: "Fashion", image: "https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=600&h=800&fit=crop", affiliateUrl: "https://s.click.aliexpress.com/e/_DkYf8Fm", source: "aliexpress", tags: ["נעליים", "ריצה", "נשים"] }),
    createProduct({ id: "p2", marketerId: owner, title: "מעיל חורף חם עם כובע — ₪129", description: "מעיף חורף מבודד עם כובע נשלף. חם וקל. מתאים לגברים ונשים.", price: 129, category: "Fashion", image: "https://images.unsplash.com/photo-1539533018447-63fcce2678e3?w=600&h=800&fit=crop", affiliateUrl: "https://s.click.aliexpress.com/e/_DpQw3Rt", source: "aliexpress", tags: ["מעיל", "חורף", "חם"] }),
    createProduct({ id: "p3", marketerId: owner, title: "סרום ויטמין C 30ml — ₪45", description: "סרום פנים עשיר בויטמין C להבהיר את העור והפחתת כתמים. לכל סוגי העור.", price: 45, category: "Beauty", image: "https://images.unsplash.com/photo-1620916566398-39f1143ab7be?w=600&h=800&fit=crop", affiliateUrl: "https://s.click.aliexpress.com/e/_DkYf8Fm", source: "aliexpress", tags: ["סרום", "ויטמין C", "טיפוח"] }),
    createProduct({ id: "p4", marketerId: owner, title: "מסקרה מגדלת מים-עמידה — ₪29", description: "מסקרא איכותית להגדלת הריסים. מים-עמידה, נוחה לשימוש יומי.", price: 29, category: "Beauty", image: "https://images.unsplash.com/photo-1596462502278-27bfdc403348?w=600&h=800&fit=crop", affiliateUrl: "https://s.click.aliexpress.com/e/_DpQw3Rt", source: "aliexpress", tags: ["מסקרה", "איפור", "ריסים"] }),
    createProduct({ id: "p5", marketerId: owner, title: "מנורת לילה חכמה + טעינה אלחוטית — ₪79", description: "מנורת לילה עם גווני אור מתכווננים, טעינה אלחוטית וכיבוי עתי.", price: 79, category: "Home", image: "https://images.unsplash.com/photo-1507473885765-e6ed057f782c?w=600&h=800&fit=crop", affiliateUrl: "https://s.click.aliexpress.com/e/_DkYf8Fm", source: "aliexpress", tags: ["מנורה", "חכמה", "טעינה אלחוטית"] }),
    createProduct({ id: "p6", marketerId: owner, title: "סט כלי מטבח סטנלס 12 חלקים — ₪159", description: "סט כלי מטבח איכותי מפלדת אל-חלד. כולל סכים, כפיות, מלקחיים.", price: 159, category: "Home", image: "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=600&h=800&fit=crop", affiliateUrl: "https://s.click.aliexpress.com/e/_DpQw3Rt", source: "aliexpress", tags: ["מטבח", "כלים", "סטנלס"] }),
    createProduct({ id: "p7", marketerId: owner, title: "אוזניות בלוטוט' ביטול רעש — ₪89", description: "אוזניות אלחוטיות עם ביטול רעש, עמידות במים, עד 8 שעות פעילות.", price: 89, category: "Tech", image: "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=600&h=800&fit=crop", affiliateUrl: "https://s.click.aliexpress.com/e/_DkYf8Fm", source: "aliexpress", tags: ["אוזניות", "בלוטות'", "רעש"] }),
    createProduct({ id: "p8", marketerId: owner, title: "מצלמת אבטחה WiFi ראיית לילה — ₪119", description: "מצלמת אבטחה חכמה עם WiFi, ראיית לילה, זיהוי תנועה והתראות.", price: 119, category: "Tech", image: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600&h=800&fit=crop", affiliateUrl: "https://s.click.aliexpress.com/e/_DpQw3Rt", source: "aliexpress", tags: ["מצלמה", "אבטחה", "חכמה"] }),
    createProduct({ id: "p9", marketerId: owner, title: "משקולות כושר מתכוונות 2-20kg — ₪249", description: "זוג משקולות מתכוונות עם מנגנון סיבוב. לאימוני כוח וכושר.", price: 249, category: "Fitness", image: "https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=600&h=800&fit=crop", affiliateUrl: "https://s.click.aliexpress.com/e/_DkYf8Fm", source: "aliexpress", tags: ["משקולות", "כושר", "אימון"] }),
    createProduct({ id: "p10", marketerId: owner, title: "מזרן יוגה אנטי-החלקה 6mm — ₪59", description: "מזרן יוגה איכותי עם משטח אנטי-החלקה. ליוגה, פילאטיס ומתיחות.", price: 59, category: "Fitness", image: "https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=600&h=800&fit=crop", affiliateUrl: "https://s.click.aliexpress.com/e/_DpQw3Rt", source: "aliexpress", tags: ["יוגה", "מזרן", "אימון"] }),
    createProduct({ id: "p11", marketerId: owner, title: "תיק גב ארגונומי כיס חשמל — ₪139", description: "תיק גב ארגונומי עם כיס לחשמל/טאבלט, רצועות נוחות, עמיד במים.", price: 139, category: "Accessories", image: "https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=600&h=800&fit=crop", affiliateUrl: "https://s.click.aliexpress.com/e/_DkYf8Fm", source: "aliexpress", tags: ["תיק", "גב", "נסיעות"] }),
    createProduct({ id: "p12", marketerId: owner, title: "שעון יח חכם דופק + ספירמומטר — ₪199", description: "שעון חכם עם מסך צבע, דופק, ספירמומטר, מעקב שינה. 7 ימים טעינה.", price: 199, category: "Accessories", image: "https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=600&h=800&fit=crop", affiliateUrl: "https://s.click.aliexpress.com/e/_DpQw3Rt", source: "aliexpress", tags: ["שעון", "חכם", "דופק"] }),
    createProduct({ id: "p13", marketerId: owner, title: "ערכת מתנה אמה — פרחים + שוקולד — ₪89", description: "ערכת מתנה עם פרחים יבשים, שוקולד איכותי וכרטיס. אריזה יפה.", price: 89, category: "Gifts", image: "https://images.unsplash.com/photo-1549465220-1a8b9238f735?w=600&h=800&fit=crop", affiliateUrl: "https://s.click.aliexpress.com/e/_DkYf8Fm", source: "aliexpress", tags: ["מתנה", "אמה", "שוקולד"] }),
    createProduct({ id: "p14", marketerId: owner, title: "בושם נשים איכותי 100ml — ₪69", description: "בושם נשים עדין עם ניחוח פרחוני. עמיד לכל היום, אריזה אלגנטית.", price: 69, category: "Gifts", image: "https://images.unsplash.com/photo-1541643600914-78b084683601?w=600&h=800&fit=crop", affiliateUrl: "https://s.click.aliexpress.com/e/_DpQw3Rt", source: "aliexpress", tags: ["בושם", "מתנה", "נשים"] }),
    createProduct({ id: "p15", marketerId: owner, title: "תיק נסיעות עמיד במים — ₪179", description: "תיק נסיעות עם מגן לחשמל, עמיד במים, בטוח למטוס.", price: 179, category: "Travel", image: "https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=600&h=800&fit=crop", affiliateUrl: "https://s.click.aliexpress.com/e/_DkYf8Fm", source: "aliexpress", tags: ["נסיעות", "תיק", "טרוול"] }),
    createProduct({ id: "p16", marketerId: owner, title: "ערכת טיפוח פנים 10 שלבים — ₪89", description: "ערכת טיפוח פנים מלאה עם סרומים, מסכות וקרמים. לעור זך ובריא.", price: 89, category: "Beauty", image: "https://images.unsplash.com/photo-1556228720-195a672e8a03?w=600&h=800&fit=crop", affiliateUrl: "https://s.click.aliexpress.com/e/_DpQw3Rt", source: "aliexpress", tags: ["טיפוח", "פנים", "סקיןקייר"] }),
    createProduct({ id: "p17", marketerId: owner, title: "אופניים חשמליות מתקפלות — ₪1,299", description: "אופניים חשמליות מתקפלות עם סוללה לעד 30 ק״מ. קלות ונוחות.", price: 1299, category: "Fitness", image: "https://images.unsplash.com/photo-1571068316344-75bc76f77890?w=600&h=800&fit=crop", affiliateUrl: "https://s.click.aliexpress.com/e/_DkYf8Fm", source: "aliexpress", tags: ["אופניים", "חשמלי", "תחבורה"] }),
    createProduct({ id: "p18", marketerId: owner, title: "עכבר גיימינג אורטוגוני — ₪69", description: "עכבר גיימינג אורטוגוני עם אורות RGB, נוח לשימוש ממושך.", price: 69, category: "Tech", image: "https://images.unsplash.com/photo-1527864550417-7fd91fc51a46?w=600&h=800&fit=crop", affiliateUrl: "https://s.click.aliexpress.com/e/_DpQw3Rt", source: "aliexpress", tags: ["גיימינג", "עכבר", "טק"] }),
