...
// helper to build a product row quickly
const P = (id, marketerId, title, description, image, price, commission, category, clicks, agoDays) => ({
  id,
  marketerId,
  title,
  description,
...
export const SEED_PRODUCTS = [
  P("p-01", "cr-maya", "שמלת קיץ מקסי מאריג משי",
  ...
  P("p-02", "cr-maya", "מעיל פסים קשמיר רך",
  ...
  P("p-03", "cr-maya", "תיק עור אמיתי בסגנון בלגי",
  ...
  P("p-04", "cr-maya", "עגילי כסף מינימליסטיים",
  ...
  P("p-15", "cr-shira", "שטיח יוגה אקולוגי",
