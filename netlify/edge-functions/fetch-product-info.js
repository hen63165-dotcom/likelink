// Netlify Edge Function — fetch-product-info
//
...
//
// This function runs in the Netlify Edge runtime (Deno). It is deployed via a
// git-connected Netlify site (Netlify auto-detects netlify/edge-functions/).
// NOTE: not reachable under plain `npm run dev` — use `netlify dev` or a
// deployed preview; if unavailable the client falls back to local og:image.
...
export const config = { path: "/api/fetch-product-info" };
